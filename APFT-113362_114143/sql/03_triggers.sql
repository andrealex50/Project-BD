...
BEGIN
    ...
    -- Verificar cada lista afetada pela inser��o
    ...
    BEGIN
        -- Contar quantos jogos existem na lista ap�s a inser��o
        ...
        BEGIN
            ...
            RAISERROR('Erro: A lista j� cont�m o n�mero m�ximo de jogos permitidos (%d). N�o � poss�vel adicionar mais jogos.', 
